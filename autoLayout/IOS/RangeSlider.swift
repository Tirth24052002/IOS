...
class RangeSlider: UIControl {
    ...
    var thumbImage = UIImage(imageLiteralResourceName: "sliderIcon") {
        didSet {
    ...
    var highlightedThumbImage = UIImage(imageLiteralResourceName: "redCircle") {
        didSet {
    ...
    // MARK: - Function Postion for Value
    func positionForValue(_ value: CGFloat) -> CGFloat {
        return bounds.width * value
    }
    
    // MARK: - Function Thumb Origin
